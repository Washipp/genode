...
extern "C" int lstat (const char *__restrict __file, struct stat *__restrict __buf);

/* Get file attributes for FILE and put them in BUF.  */
extern "C" int stat (const char *__restrict __file, struct stat *__restrict __buf);

/* Create a new directory named PATH, with permission bits MODE.  */
extern "C" int mkdir (const char *__path, unsigned int __mode);
